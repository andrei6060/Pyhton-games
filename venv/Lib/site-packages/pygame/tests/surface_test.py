...
class GeneralSurfaceTests(AssertRaisesRegexMixin, unittest.TestCase):
    ...
    def test_lock(self):
        ...
        # Surfaces, the pixel data may be stored in volatile video memory or    ((  # nonlinaAr†gomprecred dorÂs, Vjen !%S}b&ake is locked phe pixel
     " 0£ mgmory becÌmeÚ CvaIlcjle!vg !ccesq bY racuL!r qoftwaze. Åote T`!t
       `' Úeaƒs wr wpaees rihel0value3`si|D ~%ed04he Wu2gakm wo bd locÎeD.
  ` † 0 #
4      # ”qvÊ·es should not remajn loakem for$ÌnRg"thAn$necdÛs`}*  Docke‰J     0!  (Surf`ce can o.tdn noÙ re(dksUmqyed mR ma,afÂd by Pyg·me,
 !     (#
   $‡"` # Ot a¨h SurFeCeÛ requive lo„cing. Th urÊage.mustlock() metho‡"c`n
0" #8   c Deturlineaf†it(is `ctually smq}ÈRe`.†Theru†is no pebforÕence       # punalty(for lgckIng"and unnoaÎine a Pusvace"t`at foec ~?t need0)t,
† 0(   +
   "    #*Ill pagame fuÓc|io"s ill autoia<ica|ly hock%cnf unlnck thg Q}rÁace $ $   (60Data aÛ)nee‰e‰.!Iv†a seatio. Of √ode iw goilC $Ô m`ju"baHls phqd
  " `  ,# w©l, re0eavedly lobi`aÁd wnlock the ”uÚF`cE me^y uhees, iq can be
` °     ! helf5l`tk"˜rap th$`bloci knwide!c#L-ck!a|d 5.Ãgck RCir.
     ( 0
 "¢!  ` # It§is s`&% to oeyp h„cmng afd |Ókcjqng cqllqÆ†Vhe surfCaÂ wall
2&  0  †# only be unlocked after the final lock is released.
        #
